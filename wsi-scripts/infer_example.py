...
def get_data(mm_type: Literal['text', 'image', 'video', 'audio']):
    ...
    if mm_type == 'text':
        ...
        messages = [
            {'role': 'system', 'content': 'You are a multimodal AI assistant capable of understanding images.'},
            {'role': 'user', 'content': '<image>This is a single choice question.\nWhat vascular abnormality is visible in the slide?\nOptions: A. Vasculitis B. Thrombosis C. Aneurysm D. Normal vessels\nPlease only output the letter corresponding to the correct choice (A/B/C/D).\nAnswer:'}]
        # Support URL/Path/base64/PIL.Image
        data['images'] = ["/data1/liuxiaoyu/wrap/q1m/img_crop/1.0%1.00%0@994701482116173824_0.jpg"]
    elif mm_type == 'video':
...
if __name__ == '__main__':
    ...
    checkpoint_path = "/data1/liuxiaoyu/outputs/optimus-qwen3-sft-stage2/v2-20250929-132917/checkpoint-100"
    #checkpoint_path = "/data1/liuxiaoyu/outputs/optimus-qwen3-sft-stage2/v30-20251004-155043/checkpoint-10"
    if infer_backend == 'pt':
        engine = PtEngine(checkpoint_path, max_batch_size=1)
        ...
        engine = VllmEngine(checkpoint_path, max_model_len=4096, limit_mm_per_prompt={'image': 5, 'video': 2})
